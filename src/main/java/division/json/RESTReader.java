...
public class RESTReader {
  ...
  public PropertyMap get(String urlstring, Map request) {
    ...
    try {
      ...
      for(Object h:P.get("REST.headers", List.class)) {
        Map header = new ObjectMapper().readValue(String.valueOf(h), Map.class);
        connection.setRequestProperty(String.valueOf(header.get("name")), String.valueOf(header.get("value")));
      }
  ...
  public PropertyMap get(String urlstring, String request) {
    ...
    return get(urlstring, PropertyMap.create().put(P.String("REST.json-key"), new SimpleStringProperty(request)).getSimpleMap());
  }
