...
public interface PropertyMap extends Serializable {
  ...
  public default PropertyMap put(String key, String value) {
    getMap().put(key, new SimpleStringProperty(value));
    return this;
  }

  public default PropertyMap put(String key, Object value) {
    getMap().put(key, new SimpleObjectProperty(value));
    return this;
  }
